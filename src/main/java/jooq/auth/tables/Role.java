...
public class Role extends TableImpl<RoleRecord> {
    ...
    /**
     * The reference instance of <code>auth.role</code>
     */
    ...
    /**
     * The column <code>auth.role.id</code>.
     */
    public final TableField<RoleRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>auth.role.sys_name</code>.
     */
    public final TableField<RoleRecord, String> SYS_NAME = createField(DSL.name("sys_name"), SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>auth.role.description</code>.
     */
    public final TableField<RoleRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.VARCHAR(4000), this, "");

    /**
     * The column <code>auth.role.is_actual</code>.
     */
    public final TableField<RoleRecord, Boolean> IS_ACTUAL = createField(DSL.name("is_actual"), SQLDataType.BOOLEAN, this, "");
    ...
    /**
     * Create an aliased <code>auth.role</code> table reference
     */
    ...
    /**
     * Create a <code>auth.role</code> table reference
     */
    public Role() {
    ...
    public List<UniqueKey<RoleRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.ROLE_UK1);
    }

    private transient UserAccountPath _userAccount;

    /**
     * Get the implicit to-many join path to the <code>auth.user_account</code>
     * table
     */
    public UserAccountPath userAccount() {
        if (_userAccount == null)
            _userAccount = new UserAccountPath(this, null, Keys.USER_ACCOUNT__ROLE_FK1.getInverseKey());
