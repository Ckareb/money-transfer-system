...
public class Keys {
    ...
    public static final UniqueKey<AccountStatusRecord> ACCOUNT_STATUS_PKEY = Internal.createUniqueKey(AccountStatus.ACCOUNT_STATUS, DSL.name("account_status_pkey"), new TableField[] { AccountStatus.ACCOUNT_STATUS.ID }, true);
    public static final UniqueKey<AccountStatusRecord> ACCOUNT_STATUS_STATUS_CODE_KEY = Internal.createUniqueKey(AccountStatus.ACCOUNT_STATUS, DSL.name("account_status_status_code_key"), new TableField[] { AccountStatus.ACCOUNT_STATUS.STATUS_CODE }, true);
    public static final UniqueKey<AccountTypeRecord> ACCOUNT_TYPE_PKEY = Internal.createUniqueKey(AccountType.ACCOUNT_TYPE, DSL.name("account_type_pkey"), new TableField[] { AccountType.ACCOUNT_TYPE.ID }, true);
    public static final UniqueKey<AccountTypeRecord> ACCOUNT_TYPE_TYPE_CODE_KEY = Internal.createUniqueKey(AccountType.ACCOUNT_TYPE, DSL.name("account_type_type_code_key"), new TableField[] { AccountType.ACCOUNT_TYPE.TYPE_CODE }, true);
    ...
    public static final ForeignKey<AccountRecord, AccountStatusRecord> ACCOUNT__ACCOUNT_STATUS_FK = Internal.createForeignKey(Account.ACCOUNT, DSL.name("account_status_fk"), new TableField[] { Account.ACCOUNT.STATUS_ID }, Keys.ACCOUNT_STATUS_PKEY, new TableField[] { AccountStatus.ACCOUNT_STATUS.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<AccountRecord, AccountTypeRecord> ACCOUNT__ACCOUNT_TYPE_FK = Internal.createForeignKey(Account.ACCOUNT, DSL.name("account_type_fk"), new TableField[] { Account.ACCOUNT.TYPE_ID }, Keys.ACCOUNT_TYPE_PKEY, new TableField[] { AccountType.ACCOUNT_TYPE.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
