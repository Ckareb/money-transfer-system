...
public class Account extends TableImpl<AccountRecord> {
     ...
     */
    public final TableField<AccountRecord, Long> TYPE_ID = createField(DSL.name("type_id"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>money_transfer.account.status_id</code>.
     */
    public final TableField<AccountRecord, Long> STATUS_ID = createField(DSL.name("status_id"), SQLDataType.BIGINT, this, "");
