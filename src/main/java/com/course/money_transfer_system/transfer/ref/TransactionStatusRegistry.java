...
public class TransactionStatusRegistry {

    private final ConcurrentHashMap<String, TypeInfo> registry;

    public TransactionStatusRegistry(Map<String, TypeInfo> map) {
    ...
    public TypeInfo get(String code) {
        ...
        if (type == null) {
            throw new IllegalArgumentException("Неизвестный статус транзакции: " + code);
        }
        return type;
    }
